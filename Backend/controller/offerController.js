...
router.get('/provider/:id', offers.findProviderOffer,sendOffer);


router.get('/', offers.getAll, sendOffers);

router.get('/:id', offers.find, sendOffer);// get offer by customer id

router.get('/', auth , offers.getProviderOffer, sendOffer);
